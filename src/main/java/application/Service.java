...
public class Service {
    ...
    static {
        String url = "jdbc:mysql://localhost:3307/J2EE";
        ...
        public static int insertProduct(Product newProduct){
            ...
            try {
                ...
                System.out.println("INVALID DATA, PRODUCT NOT INSERTED");
            }
        ...
        {
            String updateQuery = "UPDATE PRODUCT_INFO SET PRODUCT_NAME = ? , PRODUCT_PRICE = ? , " + "PRODUCT_TYPE = ? WHERE PRODUCT_ID = ?";
        ...
        {
            String searchQuery="SELECT * FROM PRODUCT_INFO WHERE PRODUCT=?";
